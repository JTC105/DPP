        ...
        <div class="container-fluid">
          ...
          <section class="dashboard-counts no-padding-bottom">
              ...
              <div class="card-header tab-card-header">
                <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">       
                  <li class="nav-item tab-nav-item">
                      <a class="nav-link {{ $data['display']['n_admin'] }}" id="one-tab" data-toggle="tab" href="#one" role="tab" aria-controls="One" aria-selected="true">Users</a>
                  </li>
                  @permission('udealer-view-list')
                  <li class="nav-item tab-nav-item">
                      <a class="nav-link" id="two-tab" data-toggle="tab" href="#two" role="tab" aria-controls="Two" aria-selected="true">Dealer Users</a>
                  </li>

                  <li class="nav-item tab-nav-item">
                      <a class="nav-link" id="three-tab" data-toggle="tab" href="#three" role="tab" aria-controls="Three" aria-selected="true">Loan Officer Users</a>
                  </li>
                  @endpermission
                  </li>
                </ul>
              ...
              <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade {{ $data['display']['n_admin'] }} p-3" id="one" role="tabpanel" aria-labelledby="one-tab">
                ...
                <div class="table-responsive">                       
                  <table class="table table-striped table-hover" id="lolistTable">
                    <thead>
                      <tr>
                        <th>Username</th>
                        <th>Role</th>
...
$(document).ready(function() {
    ...
    var table = $('#lolistTable').DataTable( {
        orderCellsTop: true,
        fixedHeader: true
    } );
