...
@section('content')
          ...
          <div class="breadcrumb-holder container-fluid">
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="/s/appcontracts" class="btn-load">Approved Contracts</a></li>
              <li class="breadcrumb-item active">Approved Contract Details</li>
              @else
              ...
              <li class="breadcrumb-item"><a href="/admin/viewappcontracts/{{auth()->user()->GetDealerInfoIfAdmin()->party_id}}" class="btn-load">Approved Contracts</a></li>
              <li class="breadcrumb-item active">Approved Contract Details</li>              
              @endpermission
              @endif
            ...
            <div class="container-fluid">
              ...
              <div class="row">
				...
				<div class="col-lg-12">
			 	...
			 	<input type="hidden" id="isApprovedContract" value="1">
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                    	<div class="form-group row">
	                      ...
	                      <div class="col-sm-9">
	                        <input type="number" id="contractId" name="contractId" placeholder="##########" value="{{$data1[0]->contract_id}}" class="form-control" maxlength="9" readonly required>
	                      </div>
	                    </div>
                    	...
                    	<div class="form-group row">
	                      ...
	                      <div class="col-sm-9">
	                        <input type="text" id="contractStat" name="contractStat" value="{{$data1[0]->contract_status}}" class="form-control" readonly>
	                      </div>
	                    </div>
	                    ...
	                    <div class="form-group row">
	                      ...
	                      <div class="col-sm-9">
	                        <input id="creditAppDate" name="creditAppDate" class="form-control" width="276" value="{{ Carbon\Carbon::parse($data1[0]->credit_app_dt)->format('m/d/Y') }}" class="form-control" readonly>
	                      </div>
	                    </div>
	                    ...
	                    <div class="form-group row">
	                      ...
	                      <div class="col-sm-9">
	                        <input id="creditAppValidity" name="creditAppValidity" class="form-control" width="276" value="{{ Carbon\Carbon::parse($data1[0]->credit_app_validity)->format('m/d/Y') }}" class="form-control" readonly>
	                      </div>
	                    </div>
	                    ...
	                    <div class="form-group row">
	                      ...
	                      <div class="col-sm-9">
	                      	<input type="hidden" value="{{$data1[0]->recon_dt}}" id="reconDateValue" name="reconDateValue"> 
	                        @if($data1[0]->recon_dt != "")
	                        	<input id="reconDate" name="reconDate" class="form-control" width="276" value="{{ Carbon\Carbon::parse($data1[0]->recon_dt)->format('m/d/Y') }}" class="form-control" readonly>
	                        @else	                        	
	                        	None
	                        @endif
	                      </div>
	                    ...
	                    <div class="form-group row">
	                      ...
	                      <div class="col-sm-9">
	                        <input id="creditAppReconDate" name="creditAppReconDate" class="form-control" width="276" value="{{ Carbon\Carbon::parse($data1[0]->credit_app_recon_dt)->format('m/d/Y') }}" class="form-control" readonly>
	                      </div>
	                    </div>
	                	{{-- </div> --}}
	                    <!-- END FOR REPORT -->
	                      ...
	                      <div class="col-sm-9">
	                        <select id="productType" name="productType" class="form-control">
	                          @foreach($data['producttype'] as $d)
	                          	<option value="{{$d->field_id}}" {{ $producttype == $d->field_id ? 'selected' : '' }}>{{$d->field_name}}</option>
	                          @endforeach
	                        </select>
	                      </div>
	                    </div>
              	...
              	<div class="card">
                    ...
                    <div class="card-body">
	                    ...
	                    <div class="form-group row">
	                      ...
	                      <div class="col-sm-9">
	                        <input type="text" id="clientName" name="clientName" placeholder="Name" value="{{$data1[0]->client}}" class="form-control contractTI" required>
	                      </div>
	                    </div>
	                    ...
	                    <div class="form-group row">
	                      ...
	                      <div class="col-sm-9">
	                        <textarea id="clientAddress" name="clientAddress" class="form-control contractTI" required>{{$data1[0]->client_address}}</textarea>
	                      </div>
	                    </div>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
	                    ...
	                    <div class="form-group row">
	                      ...
	                      <div class="col-sm-9">
	                        <input id="comakerName" name="comakerName" type="text" placeholder="Name" value="{{$data1[0]->comaker}}" class="form-control contractTI">
	                      </div>
	                    </div>
                    ...
                    <div class="card-body">
                		...
                		<div class="form-group row">
	                      ...
	                      <div class="col-sm-9">
	                        ...
	                        <select id="vehicleName" name="vehicleName" class="form-control contractTI">
	                          <option value="">...</option>
	                          @foreach($data['vehicle'] as $vehicle)
	                          <option value="{{$vehicle->id}}" {{ (strtoupper($data1[0]->unit) == $vehicle->name) ? 'selected' : ''}}>{{$vehicle->name}}</option>
	                          @endforeach
	                        </select>
	                    	</div>

	                        @foreach($data['vehicle'] as $vehicle)
	                        	@if(strtoupper($data1[0]->unit) == $vehicle->name)
	                        	<p>{{$vehicle->name}}</p>
	                        	@endif
	                        @endforeach
	                      </div>
	                    ...
	                    <div class="form-group row">
	                      ...
	                      <div class="col-sm-9">
	                        <input id="vehicleMake" name="vehicleMake" type="text" placeholder="TOYOTA" value="TOYOTA" class="form-control contractTI" required>
	                      </div>
	                    </div>
	                    ...
	                    <div class="form-group row">
	                      ...
	                      <div class="col-sm-9">
	                        <input id="vehicleYearModel" name="vehicleYearModel" type="number" placeholder="Year Model" value="{{$data1[0]->model}}" class="form-control" required>
	                      </div>
	                    </div>
	                    ...
	                    <div class="form-group row">
	                      ...
	                      <div class="col-sm-9">
	                        <input id="invoiceNo" name="invoiceNo" type="text" placeholder="Invoice No." value="{{$invoiceNo}}" class="form-control contractTI">
	                      </div>
	                    </div>
                    ...
                    <div class="card-body">
                    	...
                    	<div class="col-sm-4">
		                   ...
		                   <div class="form-group row">
		                      ...
		                      <div class="col-sm-7">
		                        <input id="balloonAmount" name="balloonAmount" type="text" value="0.00" disabled class="form-control">
		                      </div>
		                    </div>
		                    ...
		                    <div class="form-group row">
		                      ...
		                      <div class="col-sm-7">
		                        <input id="unitCost" name="unitCost" type="text" placeholder="0.00" value="{{$data1[0]->unit_cost}}" class="form-control fin-number fin-comp" required>
		                      </div>
		                    </div>
		                    <div class="form-group row">
		                      <label class="col-sm-5 form-control-label">Downpayment <span class="badge"><i class="fas fa-asterisk required-icon"></i></span></label>
		                      <div class="col-sm-7">
		                        <input id="downPayment" name="downPayment" type="text" placeholder="0.00" value="{{$data1[0]->downpayment}}" class="form-control fin-number fin-comp" required>
		                      </div>
		                    </div>
		                    ...
		                    <div class="form-group row">
		                      ...
		                      <div class="col-sm-7">
		                        <input id="amountFinance" name="amountFinance" type="text" value="{{$data1[0]->amt_financed}}" readonly class="form-control">
		                      </div>
		                    </div>
                    	...
                    	<div class="col-sm-4">
                    		...
                    		<div class="form-group row">
		                      ...
		                      <div class="col-sm-7">
		                        <input id="term" name="term" type="number" placeholder="0" value="{{$data1[0]->term}}" class="form-control fin-comp" required>
		                      </div>
		                    </div>
                    	...
                    	<div class="col-sm-4">
		                    ...
		                    <div class="form-group row">
		                      ...
		                      <div class="col-sm-7">
		                        <input id="otherCharges" name="otherCharges" type="text" placeholder="0.00" class="form-control fin-number fin-comp">
		                      </div>
		                    </div>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                		<div class="form-group row">
	                      ...
	                      <div class="col-sm-10">
	                        <input type="hidden" id="cusReqs" name="cusReqs" value="{{$data1[0]->requirements}}">
	                        <p>{!! nl2br(e($data1[0]->requirements)) !!}</p>
	                      </div>
	                    </div>
