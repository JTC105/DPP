<!-- Modal-->
<div id="modalRolePerm" tabindex="-1" role="dialog" aria-labelledby="modalRolePermLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog modal-dialog-centered modal-lg modalRolePermCont" >
    <div class="modal-content" >

      <div class="modal-header">
        <h4 id="modalRolePermLabel" class="modal-title">Role Permissions <span id="unameLP2" class="badge badge-pill">...</span></h4>
        <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
      </div>

      <form class="form-horizontal" method="POST" action="/admin/rolepermsave">
      {{ csrf_field() }}
      ...
      <div class="modal-body">  
          ...
          <div class="form-group row">          
            ...
            <div class="col-sm-3">
              ...
              <label for="roleL2_7" class="checkbox-custom-label role-label"> Upload File Log</label>
            </div>

            <div class="col-sm-3">
              <input id="roleL2_43" name="roleL2[]" type="checkbox" class="form-control-custom" value="contract-update-con-req">
              <label for="roleL2_43" class="checkbox-custom-label role-label"> File Requirements</label>
            </div>
          </div>
          ...
          <div class="form-group row">
           ...
           <div class="form-group row">
            <div class="col-sm-3">
              <label class="role-label"><i>User</i></label>
            </div>
          ...
          <div class="line"></div>
            ...
            <div class="form-group row">
              <div class="col-sm-12">
                <b>BOOKING GUIDELINES</b>
              </div>
            </div>

           <div class="form-group row">
            <div class="col-sm-3">
              <input id="roleL2_44" name="roleL2[]" type="checkbox" class="form-control-custom" value="dash-bguide-view">
              <label for="roleL2_44" class="checkbox-custom-label role-label"> View</label>
            </div>

            <div class="col-sm-3">
              <input id="roleL2_45" name="roleL2[]" type="checkbox" class="form-control-custom" value="dash-bguide-edit">
              <label for="roleL2_45" class="checkbox-custom-label role-label"> Edit</label>
            </div>          
          </div>
          ...
          <div class="line"></div>
           ...
           <div class="form-group row">
            <div class="col-sm-3">
              <input id="roleL2_46" name="roleL2[]" type="checkbox" class="form-control-custom" value="dash-news-view-all">
              <label for="roleL2_46" class="checkbox-custom-label role-label"> View All</label>
            </div>

            <div class="col-sm-3">
              <input id="roleL2_47" name="roleL2[]" type="checkbox" class="form-control-custom" value="dash-news-view-specific">
              <label for="roleL2_47" class="checkbox-custom-label role-label"> View Specific</label>
            </div>

            <div class="col-sm-3">
              <input id="roleL2_48" name="roleL2[]" type="checkbox" class="form-control-custom" value="dash-news-add">
              <label for="roleL2_48" class="checkbox-custom-label role-label"> Add</label>
            </div>  

            <div class="col-sm-3">
              <input id="roleL2_49" name="roleL2[]" type="checkbox" class="form-control-custom" value="dash-news-edit">
              <label for="roleL2_49" class="checkbox-custom-label role-label"> Edit</label>
            </div>            
          </div>
          ...
          <div class="line"></div>
           ...
           <div class="form-group row">
            <div class="col-sm-6">
              <input id="roleL2_50" name="roleL2[]" type="checkbox" class="form-control-custom" value="report-gen-appcon">
              <label for="roleL2_50" class="checkbox-custom-label role-label">Approved Contracts</label>
            </div>

            <div class="col-sm-3">
              <input id="roleL2_51" name="roleL2[]" type="checkbox" class="form-control-custom" value="report-gen-con">
              <label for="roleL2_51" class="checkbox-custom-label role-label"> Contracts</label>
            </div>          
          </div>
           ...
           <div class="line"></div>
            ...
            <div class="form-group row">
              <div class="col-sm-12">
                <b>DATE RESTRICTION</b>
              </div>
            </div>

             <div class="form-group row">
            <div class="col-sm-6">
              <input id="roleL2_52" name="roleL2[]" type="checkbox" class="form-control-custom" value="date-restriction">
              <label for="roleL2_52" class="checkbox-custom-label role-label">No Limit</label>
            </div>
