<!-- Modal-->
<div id="bguidelienAddMV" tabindex="-1" role="dialog" aria-labelledby="bguidelienEditMVLabel" aria-hidden="true" class="modal fade text-left">
 ...
 <form class="form-horizontal" method="POST" action="/bookingguidesave" enctype="multipart/form-data" files="true">
      {{ csrf_field() }}
      ...
      <div class="modal-body"> 
        ...
        <!-- <input type="hidden" id="bgid" name="bgid"> -->
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
            <textarea class="form-control" id="bookingGuideContentA" name="bookingGuideContentA" style="height: 200px"></textarea>
            </div>
          </div>
